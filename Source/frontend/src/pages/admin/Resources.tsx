  ...
  useEffect(() => {
    const fetchResources = async () => {
      try {
        ...
        // Fetch from multiple endpoints or a single resources endpoint
        ...
        const resourcesData: ResourcesData = await resourcesResponse.json();

        setDepots(resourcesData.depots || []);
        setEquipment(resourcesData.equipment || []);
        setCrews(resourcesData.crews || []);
