...
print(
    f"Heavy rain events: {merged['heavy_rain_48h'].sum()} hours ({merged['heavy_rain_48h'].sum() / len(merged) * 100:.2f}%)")
...
print(
    f"Potential snowmelt hours: {merged['potential_snowmelt'].sum()} ({merged['potential_snowmelt'].sum() / len(merged) * 100:.2f}%)")
...
print(
    f"Normal: {(merged['flood_level'] == 'Normal').sum()} hours ({(merged['flood_level'] == 'Normal').sum() / len(merged) * 100:.1f}%)")
print(
    f"Flood: {(merged['flood_level'] == 'Flood').sum()} hours ({(merged['flood_level'] == 'Flood').sum() / len(merged) * 100:.1f}%)")
print(
    f"Major Flood: {(merged['flood_level'] == 'Major Flood').sum()} hours ({(merged['flood_level'] == 'Major Flood').sum() / len(merged) * 100:.1f}%)")
