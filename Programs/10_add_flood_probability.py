...
if actual_floods > 0:
    ...
    print(f"  Caught by high risk forecast:     {caught_high}/{actual_floods} ({caught_high/actual_floods*100:.0f}%)")
    print(f"  Caught by moderate+ risk forecast: {caught_mod}/{actual_floods} ({caught_mod/actual_floods*100:.0f}%)")
